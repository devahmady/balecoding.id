                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <a href="/dashboard/download/create" class="btn btn-icon icon-left btn-primary"><i
                                    class="far fa-edit"></i> Create File</a>
                                        ...
                                        @foreach ($download as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="/dashboard/download/{{ $item->id }}" method="post"
                                                        class="d-inline">
                                                        @method('Delete')
                                                        @csrf
