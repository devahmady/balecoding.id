...
@endsection
@section('img')
{{ asset('storage/' . $data1->img) }}
@endsection
@section('slug')
{{ asset('blog/' . $data1->slug) }}
@endsection
                        ...
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                    href="category/{{ $data1->category->slug }}">{{ $data1->category->name }}</a>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-white border border-top-0 p-3">
                            ...
                            @else
                                <a href="/auth/login" class="d-block w-100 text-white text-decoration-none mb-3"
                                    style="background: #39569E;">
                                    <i class="fas fa-sign-in-alt text-center py-4 mr-3"
                                        style="width: 65px; background: rgba(0, 0, 0, .2);"></i>
                                    <span class="font-weight-medium">Login</span>
                                </a>
                                <a href="/auth/daftar" class="d-block w-100 text-white text-decoration-none mb-3"
